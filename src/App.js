...
import oracleSurgery from './images/oral-surgery.svg'
import painlessDentistry from './images/painless-dentistry.svg'
...
const App = () => {
  ...
  return (
    ...
    <div class="bg-gray-100">
      ...
      items-center min-h-screen">
        <div class="h-full absolute top-0 left-0 z-0">
          <img src={coverBG} alt="" class="w-full h-full object-cover opacity-20"/>
        </div>
    ...
    <section class="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
      <div class="flex flex-col lg:flex-row lg:-mx-8" style={{marginTop: "-100px"}}>
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap -mx-4 -mb-10 text-center">
            <div class="sm:w-1/2 mb-10 px-4">
              <div class="rounded-lg h-64 overflow-hidden">
                <img alt="content" class="object-cover object-center h-full w-full" src={R} style={{opacity: '0.5'}}/>
              </div>
              <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">My Patient</h2>
              <p class="leading-relaxed text-base">I am patient and I need to find or share my medical records that can help me to connect with provider</p>
            ...
            <div class="sm:w-1/2 mb-10 px-4">
              <div class="rounded-lg h-64 overflow-hidden">
                <img alt="content" class="object-cover object-center h-full w-full" src={hospital} style={{opacity: '0.5'}}/>
              </div>
              <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">My Hospital</h2>
              <p class="leading-relaxed text-base">My organization isn't in the healthcare industry, and I need to retrive medical records</p>
              <button class="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">Click here</button>
            </div>
          </div>
        </div>
      ...
      <div class="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
        <div class="md:w-1/2 md:px-4 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src={teethWhitening} alt="" class="h-20 mx-auto"/>
        ...
        <div class="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src={oracleSurgery} alt="" class="h-20 mx-auto"/>
        ...
        <div class="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
          <div class="bg-white rounded-lg border border-gray-300 p-8">
            <img src={painlessDentistry} alt="" class="h-20 mx-auto"/>
